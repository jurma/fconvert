...
import com.jurma.mintos.fconvert.dto.TransferFundsDto;
...
import static com.jurma.mintos.fconvert.controller.AccountController.NO_LIMIT;
...
public class AccountService {
    ...
    public List<History> getHistory(Long accountId, Long offset, Long limit) {
        if (Long.valueOf(NO_LIMIT).equals(limit)) {
